...
class TaskCreationAgent:
    ...
    def task_creation_agent(objective: str, result: Dict, task_description: str):
        prompt = f"""
        You are a task creation AI that uses the result of an execution agent to create new tasks with the following objective: {objective},
        The last completed task has the result: {result}.
        This result was based on this task description: {task_description}. These are incomplete tasks: {', '.join(self.taskmanager.tasklist)}.
